...
export async function POST(request: NextRequest) {
  try {
    ...
    // 构建系统提示
    const systemPrompt = `你是优秀的高中语文老师，我的待处理字和词典信息是"${JSON.stringify(dictionary_info)}"，请你根据这些信息，围绕这个【字】，生成一个全新的文言文情景，考察学生的掌握情况。注意：1、文言文的主角/或者故事所发生的情境需要是${personaDescription}2、保证题目正确。3、严格按照以下示例格式输出情境和两道选择题： 
 【文言文情境】  
